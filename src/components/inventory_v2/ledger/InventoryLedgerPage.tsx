...
const DEMO_STOCK_LEDGER_ENTRIES: any[] = [
  {
    ...
    createdAt: '2026-08-12T03:39:00.000Z',
    transactionType: 'PURCHASE',
    direction: 'IN',
    skuId: { name: 'vector Reel 52 GSM 64 CM', spec: '52 GSM', brand: 'BILT', unit: 'KG' },
    batchNumber: 'PB-000004',
    reelBadge: 'PB-000004-L1-R01',
    fromLocationName: 'SKBW',
    toLocationName: 'Bottom',
    quantity: 50,
    unit: 'KG',
    balance: '50 KG',
    referenceId: 'PB-000004',
    createdBy: { fullName: 'System Administrator' },
    status: 'Posted',
    remarks: 'Lot: PB-000004-L01. Inwarded via invoice PB-000004'
  },
  {
    _id: 'demo-2',
    ...
    batchNumber: 'PB-000003',
    reelBadge: 'PB-000003-L1-R01',
    fromLocationName: 'SKBW',
    toLocationName: 'Lower Left Rack',
    quantity: 300,
    unit: 'KG',
    balance: '300 KG',
    referenceId: 'PB-000003',
    createdBy: { fullName: 'System Administrator' },
    status: 'Posted',
    remarks: 'Lot: PB-000003-L01. Inwarded via invoice PB-000003'
  },
  {
    _id: 'demo-3',
    ...
    batchNumber: 'PB-000009',
    reelBadge: 'PB-000009-L1-R01',
    fromLocationName: 'SKBW',
    toLocationName: 'Top',
    quantity: 300,
    unit: 'KG',
